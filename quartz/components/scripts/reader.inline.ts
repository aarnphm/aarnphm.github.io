...
document.addEventListener("nav", () => {
  ...
  function showReader() {
    // Find the main article element or decrypted content
    const article =
      document.querySelector(".decrypted-content.popover-hint") ||
    ...
    // Get the title from either the main page or within decrypted content
    const title =
      document.querySelector("h1.article-title")?.textContent ||
      document.querySelector(".decrypted-content h1")?.textContent ||
      ""
