...
export default (() => {
  const ChannelContent: QuartzComponent = ({ fileData, displayClass }: QuartzComponentProps) => {
    ...
    const renderBlock = (block: ArenaBlock, blockIndex: number) => {
      ...
      const snapshotSrc = block.url && block.snapshotKey
      ...
      return (
        ...
        >
          <div class="arena-block-clickable" role="button" tabIndex={0} aria-label="View block details">
  ...
  ChannelContent.afterDOMLoaded = script
