...
const en: TriDict = {
  ui: {
    ...
    'ground contact balance': 'ground contact balance',
    'ground contact dynamics': 'ground contact dynamics',
    'vertical oscillation': 'vertical oscillation',
    'vertical ratio': 'vertical ratio',
    'vertical dynamics': 'vertical dynamics',
    'step speed loss': 'step speed loss',
    'step speed loss percent': 'step speed loss percent',
    'impact load factor': 'impact load factor',
    'run/walk': 'run/walk',
    idle: 'idle',
    ...
    'torque effectiveness by watts': 'torque effectiveness by watts',
    'pedal smoothness': 'pedal smoothness',
    'pedal smoothness by watts': 'pedal smoothness by watts',
    ...
    'electronic shifting by watts': 'electronic shifting by watts',
    stamina: 'stamina',
    estimate: 'estimate',
    current: 'current',
    potential: 'potential',
    ...
    'customized front/rear width': 'customized front/rear width',
    'both tires': 'both tires',
    ...
    'power-to-weight trend': 'power-to-weight trend',
    'power-to-weight durations': 'power-to-weight durations',
    'your ride history': 'your ride history',
    'rolling best for each duration': 'rolling best for each duration',
    sample: 'sample',
    'calendar days': 'calendar days',
    'source rides': 'source rides',
    d: 'd',
    'no historical power-to-weight data': 'no historical power-to-weight data',
    duration: 'duration',
    ...
    'toggle activity': 'show or hide activity',
    ...
    'Strava distance': 'Strava distance',
    time: 'time',
    'avg hr': 'avg hr',
    ...
    cloud: 'cloud',
    'Garden estimate': 'Garden estimate',
    'ambient SED': 'ambient SED',
    'average UVI': 'average UVI',
    'peak UVI': 'peak UVI',
    'average ambient temperature': 'average ambient temperature',
    'average cloud cover': 'average cloud cover',
    'covered duration': 'covered duration',
    'Weather Impact': 'Weather Impact',
    CdA: 'CdA',
    'CdA detail':
      'Aerodynamic drag area, $C_d A$: drag coefficient multiplied by frontal area. MyWindsock reports it in $\\mathrm{m}^2$.',
    ...
    headwind: 'headwind',
    crosswind: 'crosswind',
    'apparent air': 'apparent air',
    yaw: 'yaw',
    score: 'score',
    'Environment graph view': 'Environment graph view',
    'Cumulative exposure unit': 'Cumulative exposure unit',
    ...
    'Pulse Ox': 'Pulse Ox',
    'lowest Pulse Ox': 'lowest Pulse Ox',
    'Body Battery at bedtime': 'Body Battery at bedtime',
    'Body Battery at wake-up': 'Body Battery at wake-up',
    'Body Battery change': 'Body Battery change',
    'sleep stress': 'sleep stress',
    'restless moments': 'restless moments',
  ...
  gloss: {
    ...
    ambienttemp: {
      ...
      def: 'Ambient temperature is the overlap-weighted Apple WeatherKit estimate sampled at the route coordinate nearest each hourly midpoint. Missing weather remains a gap. Strava device temperature is reported separately.',
    },
    heatstrain: {
...
const fr: TriDict = {
  ui: {
    ...
    cadence: 'cadence',
    'performance condition': 'condition de performance',
    'ground contact time': 'temps de contact au sol',
    'ground contact balance': 'équilibre du temps de contact au sol',
    'ground contact dynamics': 'dynamique du contact au sol',
    'vertical oscillation': 'oscillation verticale',
    'vertical ratio': 'rapport vertical',
    'vertical dynamics': 'dynamique verticale',
    'step speed loss': 'perte de vitesse au sol',
    'step speed loss percent': 'pourcentage de perte de vitesse au sol',
    'impact load factor': "facteur de charge d'impact",
    'run/walk': 'course/marche',
    idle: 'arrêt',
    'stroke rate': 'fréquence de nage',
    'stroke type': 'type de nage',
    strokes: 'coups de bras',
    'air temp': "température de l'air",
    'device temp': "température de l'appareil",
    ...
    'torque effectiveness by watts': 'efficacité du couple selon les watts',
    'pedal smoothness': 'fluidité du pédalage',
    'pedal smoothness by watts': 'fluidité du pédalage selon les watts',
    ...
    'electronic shifting by watts': 'changement de vitesse électronique selon les watts',
    stamina: 'stamina',
    estimate: 'estimation',
    current: 'actuelle',
    ...
    'customized front/rear width': 'largeurs avant/arrière personnalisées',
    'both tires': 'les deux pneus',
    'Turning customization off uses the front width for both tires.':
      'Désactiver la personnalisation applique la largeur avant aux deux pneus.',
    ...
    'power-to-weight trend': 'tendance puissance-poids',
    'power-to-weight durations': 'durées puissance-poids',
    'your ride history': 'tes sorties',
    'rolling best for each duration': 'meilleur glissant pour chaque durée',
    sample: 'échantillon',
    'calendar days': 'jours civils',
    'source rides': 'sorties sources',
    d: 'j',
    'no historical power-to-weight data': 'aucun historique puissance-poids',
    duration: 'durée',
    'maximal average power sustained for each duration':
    ...
    'toggle activity': "afficher ou masquer l'activité",
    ...
    respiration: 'respiration',
    'muscle oxygen': 'oxygène musculaire',
    ...
    elevation: 'altitude',
    virtual: 'virtuelle',
    'distance source': 'source de distance',
    'telemetry source': 'source de télémétrie',
    'Strava distance': 'distance Strava',
    time: 'temps',
    'avg hr': 'fc moy',
    ...
    'UV exposure': 'exposition UV',
    'wind and aero': 'vent et aérodynamique',
    cumulative: 'cumul',
    'cum.': 'cumul.',
    UVI: 'IUV',
    'temp.': 'temp.',
    ...
    cloud: 'nuages',
    'Garden estimate': 'estimation Garden',
    'ambient SED': 'SED ambiante',
    'average UVI': 'indice UV moyen',
    'peak UVI': 'indice UV maximal',
    'average ambient temperature': 'température ambiante moyenne',
    'average cloud cover': 'couverture nuageuse moyenne',
    'covered duration': 'durée couverte',
    'Weather Impact': 'Weather Impact',
    CdA: 'CdA',
    'CdA detail':
      'Surface de traînée aérodynamique, $C_d A$ : coefficient de traînée multiplié par la surface frontale. MyWindsock la fournit en $\\mathrm{m}^2$.',
    'Feels Like Elevation': 'Feels Like Elevation',
    ...
    'apparent air': 'air apparent',
    yaw: 'lacet',
    score: 'score',
    'Environment graph view': "Vue du graphique de l'environnement",
    'Cumulative exposure unit': "Unité d'exposition cumulative",
    'Garden estimate from Apple WeatherKit. Apple Weather data modified by Garden calculations.':
      'Estimation Garden issue d’Apple WeatherKit. Données Apple Weather modifiées par les calculs Garden.',
    gust: 'rafale',
    fueling: 'nutrition',
    ...
    'lowest hr': 'fc min',
    breath: 'respiration',
    'lowest respiration': 'respiration minimale',
    'highest respiration': 'respiration maximale',
    'Pulse Ox': 'SpO₂',
    'lowest Pulse Ox': 'SpO₂ minimale',
    'Body Battery at bedtime': 'Body Battery au coucher',
    'Body Battery at wake-up': 'Body Battery au réveil',
    'Body Battery change': 'variation Body Battery',
    'sleep stress': 'stress pendant le sommeil',
    'restless moments': "moments d'agitation",
  ...
  gloss: {
    ...
    ambienttemp: {
      ...
      def: "La température ambiante est l'estimation Apple WeatherKit pondérée selon le chevauchement et relevée au point du parcours le plus proche du milieu de chaque heure. Une donnée météo manquante reste vide. La température de l'appareil Strava est indiquée séparément.",
    },
    heatstrain: {
