...
const en: TriDict = {
  ui: {
    ...
    'v-oscillation': 'vertical oscillation',
  ...
  gloss: {
    ...
    hrzones: {
      term: 'heart-rate zone distribution',
      def: 'This distribution adds the time spent in each heart-rate zone across the selected sport and date range. The zone with the largest share of total observed training time is the majority zone. Each activity contributes in proportion to its duration.',
    },
    activitytelemetry: {
...
const fr: TriDict = {
  ui: {
    ...
    'v-oscillation': 'oscillation verticale',
    ...
    'heart rate zone distribution': 'répartition des zones de fréquence cardiaque',
    'activity telemetry over time': 'télémétrie des activités dans le temps',
    'activity telemetry scrubber':
      'télémétrie des activités, utilise les flèches gauche et droite pour parcourir',
    'majority zone': 'zone dominante',
    ...
    'no heart rate zone data': 'aucune donnée de zone de fréquence cardiaque',
  ...
  gloss: {
    ...
    hrzones: {
      term: 'répartition des zones de fréquence cardiaque',
      def: "Cette répartition additionne le temps passé dans chaque zone de fréquence cardiaque pour la discipline et la période choisies. La zone qui représente la plus grande part du temps d'entraînement observé est la zone dominante. Chaque activité contribue selon sa durée.",
    },
    activitytelemetry: {
