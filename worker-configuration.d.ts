/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: be7058eab25a318d91d39d7a769ef149)
// Runtime types generated with workerd@1.20260828.1 2025-01-21 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_Env {
	...
	SYNC_REFRESH_DAYS: string;
	WAHOO_REFRESH_TOKEN_FILE: string;
	OURA_CLIENT_ID: string;
	OURA_CLIENT_SECRET: string;
	OURA_REFRESH_TOKEN: string;
	GARMIN_CONNECT_BROWSER: string;
	GARMIN_CONNECT_DELAY_MS: string;
	GARMIN_USERNAME: string;
	GARMIN_PASSWORD: string;
	WEATHERKIT_TEAM_ID: string;
	WEATHERKIT_SERVICE_ID: string;
	WEATHERKIT_KEY_ID: string;
	WEATHERKIT_PRIVATE_KEY_FILE: string;
	APPLE_HEALTH_FILE: string;
	CORE_BODY_TEMP_EMAIL: string;
	CORE_BODY_TEMP_PASSWORD: string;
	CORE_BODY_TEMP_FIREBASE_API_KEY: string;
	WAHOO_CLIENT_ID: string;
	WAHOO_CLIENT_SECRET: string;
	WAHOO_REFRESH_TOKEN: string;
