...
this repo powers a quartz-based digital garden with custom plugins and a cloudflare worker. it also contains tools and implementations in rust, python, go, c, and c++ under `content/`.
