...
- 12 inch All-Clad sauté pan
- Stand-mixer
- Sous-vide machine
- Japanese knife (Nakiri, Gyuto, and more) [^items]

[^items]: I'm not too big into kitchen equipment. Most of the tools I use are industry-standard, but omitted here for brevity. These include deli containers, stock pots, and pairs of [Joyce Chen Scissors](https://www.amazon.ca/Original-Unlimited-Kitchen-Scissors-Handles/dp/B0000CFLH7?th=1).
