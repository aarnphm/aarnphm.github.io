...
$R_2-R_1 \rightarrow A|b \leftarrow \begin{bmatrix} 0.1 & 0.3 & 0.9 | 1.3\\ 0.2 & 0.6 & 1.8 | 2.6\\ 0.6 & 0.7 & 0.1 | 1.4 \end{bmatrix}$

$R_3-3R_1 \rightarrow A|b \leftarrow \begin{bmatrix} 0.1 & 0.3 & 0.9 | 1.3\\ 0.2 & 0.6 & 1.8 | 2.6\\ 0.3 & -0.2 & -2.6 | -2.5 \end{bmatrix}$

$R_3-\frac{1}{2}R_2 \rightarrow A|b \leftarrow \begin{bmatrix} 0.1 & 0.3 & 0.9 | 1.3\\ 0.2 & 0.6 & 1.8 | 2.6\\ 0.2 & -0.5 & -3.5 | -3.8 \end{bmatrix}$

Thus $A|b \leftarrow \begin{bmatrix} 0.1 & 0.3 & 0.9 | 1.3\\ 0.2 & 0.6 & 1.8 | 2.6\\ 0.2 & -0.5 & -3.5 | -3.8 \end{bmatrix}$

$det(A) = a(ei−fh)−b(di−fg)+c(dh−eg)$ where $A=\begin{bmatrix} a & b & c \\ d & e & f\\ g & h & i \end{bmatrix}$
$det(A) = 0.1*(-0.6*3.5+1.8*0.5)-0.3*(-0.2*3.5-1.8*0.2) + 0.9*(-0.5*0.2-0.6*0.2) = 0$

> [!IMPORTANT]
> Therefore, _$A$ is singular_
...
We notice that $R3-\frac{1}{3}R2 \rightarrow 0x_1 + 0x_2 + 0x_3=-0.3$, therefore render this invalid.
...
$R3 \leftrightarrow R1 \rightarrow U=\begin{bmatrix} 0.6 & 0.7 & 0.1\\ 0.3 & 0.9 & 2.7\\ 0.1 & 0.3 & 0.9 \end{bmatrix}$, $P_1=\begin{bmatrix} 0 & 0 & 1\\ 0 & 1 & 0\\ 1 & 0 & 0 \end{bmatrix}$

$R2 - \frac{1}{2}R1 \rightarrow U=\begin{bmatrix} 0.6 & 0.7 & 0.1\\ 0 & 0.55 & 2.6500000000000004\\ 0.1 & 0.3 & 0.9 \end{bmatrix}$

$R3 - \frac{1}{6}R1 \leftarrow U=\begin{bmatrix} 0.6 & 0.7 & 0.1\\ 0 & 0.55 & 2.6500000000000004\\ 0 & 0.18333333333333335 & 0.8833333333333333 \end{bmatrix}$

$R3 - \frac{1}{3}R2 \leftarrow U=\begin{bmatrix} 0.6 & 0.7 & 0.1\\ 0 & 0.55 & 2.6500000000000004\\ 0 & 0 & 4.8109664400423476×10^{−17}​ \end{bmatrix}$
