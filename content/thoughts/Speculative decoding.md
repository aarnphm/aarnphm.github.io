...
modified: "2025-07-05 03:30:24 GMT-04:00"
tags:
  - ml
  - serving
  - technical
...
Improvement factor (IF) [[thoughts/Speculative decoding#walltime improvement|determines]] the value of $\alpha$.
...
- [[thoughts/Speculative decoding#walltime improvement|Walltime]] improvement by $\frac{1-\alpha^{\gamma +1}}{(1-\alpha)(\gamma c + 1)}$ where $\alpha$ is the approximation $E(\beta)$ [^approx-beta]
