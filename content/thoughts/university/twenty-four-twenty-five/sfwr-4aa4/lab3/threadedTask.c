/*============================================================================
 ...
 FIFO scheduling. Generally tasks run in an infinite loop however we use loop a
 finite loop for convenience in labs.
 ============================================================================*/

// #define _GNU_SOURCE //if you define the _GNU_SOURCE here, you do not need to,
// cnanot, add a symbol for Cross Compiler in Eclispse
//  if you add the symbol in Eclipse, you do not need to, cannot define the
//  symbol here.
...
void *tfun1(void *n) {
  ...
  while (num_runs) {
    ...
    // this return current pthread_t, which is thread id, you can convert it to
    // type "unsigned int",
