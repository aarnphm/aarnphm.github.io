 ...
 */
static const NiFpga_Status
    NiFpga_Status_CloseAndResetCalledWithResetNotSupported = -61253;
 ...
 */
static NiFpga_Inline NiFpga_Status
NiFpga_MergeStatus(NiFpga_Status *const status, const NiFpga_Status newStatus) {
  if (!status)
