...
ax.text(
  funnel_cx + (aw_right + neck_right) / 4 + 0.8,
  (trap_y_mid + trap_y_bot) / 2 - 0.1,
  '18 / 37',
  ha='left',
  va='center',
...
ax.text(
  8,
  6.5,
  'The Customer Journey: Where the Funnel Leaks',
  ha='center',
  va='center',
  fontsize=14,
  fontweight='bold',
