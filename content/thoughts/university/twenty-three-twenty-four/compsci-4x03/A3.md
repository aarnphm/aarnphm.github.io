---
date: '2023-11-30'
description: adaptive simpson's method for numerical integration, least squares fitting, composite trapezoidal and simpson's rules with error analysis.
id: A3
...
The error bound is given by $E_t\leq \frac{(b-a)^3}{12n^2}max_{a\leq x\leq b}|f^{''}(x)|$, where $f(x)=e^xcos(x)$
