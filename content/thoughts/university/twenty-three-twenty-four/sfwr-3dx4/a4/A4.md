---
date: '2024-03-28'
description: assignment on robot arm joint-control systems with bode plot analysis, bandwidth estimation, state variable feedback using ackermann's formula, and controllability.
id: A4
