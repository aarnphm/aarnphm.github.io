...
- perelman, grisha. _finite extinction time for the solutions to the ricci flow on certain three-manifolds_ (2003, math/0307245)
...
## pedagogical arxiv papers

### perelman proof expositions

- brendle, simon. _singularity models in 3d ricci flow_ (2201.02522v2, 2022) — modern perspective
- bamler, richard. _recent developments in ricci flows_ (2102.12615v1, 2021) — excellent overview
- topping, peter. _ricci flows with unbounded curvature_ (1408.6866v1, 2014) — technical issues

### related topics

- brendle-schoen. _sphere theorems in geometry_ (0904.2604v2, 2009) — curvature and topology
- anderson, michael. _scalar curvature and geometrization_ (math/0202029v1, 2002; math/0101144v1, 2001)
- hodgson-kerckhoff. _universal bounds for hyperbolic dehn surgery_ (math/0204345v1, 2002)
...
- tao, terence. blog posts on perelman's proof (2006-2008)

## problem books and exercises

- viro et al. _elementary topology problem textbook_ — 500+ problems with solutions
- kaczynski et al. _computational topology_ — algorithmic perspective
- lee's textbooks include extensive exercises with selected solutions
...
- poincaré, henri. _cinquième complément à l'analysis situs_ (1904) — original conjecture
- alexander, james. _example of a simply connected surface bounding a region which is not simply connected_ (1924) — alexander horned sphere
- whitehead, j.h.c. _certain theorems about three-dimensional manifolds_ (1935) — whitehead manifold
- papakyriakopoulos, christos. _dehn's lemma and the asphericity of knots_ (1957) — breakthrough in 3-manifold topology
...
1. work dimension-down examples (understand $S^2$ before $S^3$)
2. compute explicit examples (lens spaces, torus bundles)
3. consult multiple sources (authors have different perspectives)
4. ask for help (mathoverflow, advisors, study groups)
...
3. morgan-tian vol 3 (surgery)
4. perelman papers (with annotations)
