...
You have a physical and functional duplicate. Same neurons firing in same patterns, same behavior, same reports about "consciousness," same causal structure. But nothing it's like to be them. Lights off inside. A philosophical zombie—p-zombie for short.

The question isn't whether zombies exist. It's whether they're _conceivable_, and if conceivable, whether they're _possible_, and if possible, what that tells us about consciousness and [[thoughts/functionalism]].

## Chalmers' argument

The classic formulation: [@chalmers1996consciousmind]

1. **Conceivability**: Zombies are conceivable—you can coherently imagine a world physically identical to ours where creatures like us exist without phenomenal consciousness.
2. **Conceivability entails possibility**: If zombies are conceivable, they're metaphysically possible (possible in some possible world).
3. **Possibility refutes materialism**: If zombies are possible, then consciousness is not necessitated by physical facts alone. Some additional fact—phenomenal fact—is needed. Therefore materialism (or [[thoughts/functionalism|functionalism]]) is false.

Each step attracts objections. But if the argument works, it shows that functional organization—no matter how sophisticated, how well-integrated, how behaviorally adequate—doesn't guarantee consciousness. Something additional is required. [[thoughts/qualia]] don't reduce to causal roles.
