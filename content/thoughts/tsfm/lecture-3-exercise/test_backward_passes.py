...
def test_block_backward(causal):
  ...
  grads_np = block_backward(x, W_Q, W_K, W_V, W_O, W_FF_expand, W_FF_contract, gamma, beta, dOut, causal=causal)

  # PyTorch implementation
  grads_t = torch_block_backward(x, W_Q, W_K, W_V, W_O, W_FF_expand, W_FF_contract, gamma, beta, dOut, causal=causal)
