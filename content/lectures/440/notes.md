...
tags:
  - ml
  - workshop
title: supplement to 0[dot]440
transclude:
  title: false
---

slides: [[lectures/440/vllm-toronto-2025.pdf|infer-0.440]]

see also: [[thoughts/vllm]], [[thoughts/LLMs]], [[thoughts/Transformers|Transformers]], [[thoughts/Attention|Attention]]
...
> [!note]
> Omitting TensorRT-LLM, SGLang, and LMDeploy for simplicity.
...
see also: [[thoughts/paged attention|formal definitions]]
...
| tinyvllm     | similar    | simple      | a simplified reference implementation of vllm                                     |
...
def schedule(self):
  ...
  while self.waiting and self.token_budget > 0:
    ...
    prefill_tokens = self.allocate_slots(request)
    self.token_budget -= prefill_tokens
