...
the matching exercise pairs ten signs with their names. the pictogramme is the same everywhere, so the sign carries the vocabulary for you:

<div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(8.5rem,1fr));gap:1.1rem;margin:1.3rem 0">

<figure style="margin:0;text-align:center">
<svg viewBox="0 0 48 48" width="58" height="58" role="img" aria-label="pictogramme ascenseur">
<rect width="48" height="48" rx="7" fill="var(--dark)"/>
<path d="M19 9 L22.5 14.5 H20.5 V20 H17.5 V14.5 H15.5 Z" fill="var(--light)"/>
<path d="M29 20 L25.5 14.5 H27.5 V9 H30.5 V14.5 H32.5 Z" fill="var(--light)"/>
<rect x="13" y="23" width="22" height="17" rx="2" fill="none" stroke="var(--light)" stroke-width="2"/>
<circle cx="19" cy="28" r="2.1" fill="var(--light)"/>
<path d="M17 31.2 h4 v6.2 h-4 z" fill="var(--light)"/>
<circle cx="28.5" cy="28" r="2.1" fill="var(--light)"/>
<path d="M26.5 31.2 h4 v6.2 h-4 z" fill="var(--light)"/>
</svg>
<figcaption style="font-size:0.78rem;margin-top:0.4rem"><code>l'ascenseur</code></figcaption>
</figure>

<figure style="margin:0;text-align:center">
<svg viewBox="0 0 48 48" width="58" height="58" role="img" aria-label="pictogramme extincteur">
<rect width="48" height="48" rx="7" fill="var(--dark)"/>
<rect x="18" y="17" width="13" height="23" rx="3.5" fill="var(--light)"/>
<rect x="21.5" y="12" width="6" height="5" fill="var(--light)"/>
<rect x="19.5" y="9" width="12" height="3" rx="1.5" fill="var(--light)"/>
<path d="M32 10.5 q6 3.5 4.2 9.5 q-0.9 3.2 -3.7 4.5" fill="none" stroke="var(--light)" stroke-width="2" stroke-linecap="round"/>
<path d="M24.6 23.5 q-3.2 3.2 -1.1 5.9 q0.6 -1.9 1.7 -2.4 q-0.7 2.6 1.5 3.9 q2.6 -1.5 1.5 -4.5 q-0.5 1.1 -1.3 1.3 q0.6 -2.6 -2.3 -4.2 z" fill="var(--dark)"/>
</svg>
<figcaption style="font-size:0.78rem;margin-top:0.4rem"><code>l'extincteur</code></figcaption>
</figure>

<figure style="margin:0;text-align:center">
<svg viewBox="0 0 48 48" width="58" height="58" role="img" aria-label="pictogramme escalier">
<rect width="48" height="48" rx="7" fill="var(--dark)"/>
<path d="M8 40 V34 h8 v-6 h8 v-6 h8 v-6 h8 V40 Z" fill="var(--light)"/>
<circle cx="20" cy="13.5" r="3.2" fill="var(--light)"/>
<path d="M18.4 17.6 h3.4 l3.4 4.4 -1.9 1.6 -2.4 -2.9 v3.5 l2.6 3.6 h-3 l-2.6 -3.4 -2.4 2.9 -1.9 -1.7 3.2 -3.8 z" fill="var(--light)"/>
</svg>
<figcaption style="font-size:0.78rem;margin-top:0.4rem"><code>l'escalier</code></figcaption>
</figure>

<figure style="margin:0;text-align:center">
<svg viewBox="0 0 48 48" width="58" height="58" role="img" aria-label="pictogramme toilettes">
<rect width="48" height="48" rx="7" fill="var(--dark)"/>
<circle cx="16" cy="13" r="3.2" fill="var(--light)"/>
<path d="M16 17.2 L10.8 30.6 H21.2 Z" fill="var(--light)"/>
<rect x="13.1" y="30" width="2.4" height="8.4" fill="var(--light)"/>
<rect x="16.5" y="30" width="2.4" height="8.4" fill="var(--light)"/>
<rect x="23.4" y="9" width="1.2" height="30" fill="var(--light)" opacity="0.5"/>
<circle cx="32" cy="13" r="3.2" fill="var(--light)"/>
<rect x="28.7" y="17.2" width="6.6" height="11.4" rx="1.6" fill="var(--light)"/>
<rect x="29.5" y="28" width="2.4" height="10.4" fill="var(--light)"/>
<rect x="32.1" y="28" width="2.4" height="10.4" fill="var(--light)"/>
</svg>
<figcaption style="font-size:0.78rem;margin-top:0.4rem"><code>les toilettes</code></figcaption>
</figure>

<figure style="margin:0;text-align:center">
<svg viewBox="0 0 48 48" width="58" height="58" role="img" aria-label="pictogramme réseau sans fil">
<rect width="48" height="48" rx="7" fill="var(--dark)"/>
<path d="M10.1 25.2 A17 17 0 0 1 37.9 25.2" fill="none" stroke="var(--light)" stroke-width="3.2" stroke-linecap="round"/>
<path d="M14.6 28.4 A11.5 11.5 0 0 1 33.4 28.4" fill="none" stroke="var(--light)" stroke-width="3.2" stroke-linecap="round"/>
<path d="M19.1 31.6 A6 6 0 0 1 28.9 31.6" fill="none" stroke="var(--light)" stroke-width="3.2" stroke-linecap="round"/>
<circle cx="24" cy="36.4" r="2.6" fill="var(--light)"/>
</svg>
<figcaption style="font-size:0.78rem;margin-top:0.4rem"><code>l'accès à un réseau internet sans fil</code></figcaption>
</figure>

<figure style="margin:0;text-align:center">
<svg viewBox="0 0 48 48" width="58" height="58" role="img" aria-label="pictogramme table à langer">
<rect width="48" height="48" rx="7" fill="var(--dark)"/>
<circle cx="13.5" cy="12" r="3.4" fill="var(--light)"/>
<path d="M13.8 16.2 q1.6 6.2 7.6 8.4" fill="none" stroke="var(--light)" stroke-width="3.4" stroke-linecap="round"/>
<rect x="22" y="26" width="8.6" height="3.6" rx="1.8" fill="var(--light)"/>
<circle cx="32.4" cy="25.6" r="2.5" fill="var(--light)"/>
<rect x="9" y="30.4" width="30" height="2.6" rx="1.3" fill="var(--light)"/>
<rect x="11" y="33" width="2.2" height="6.4" fill="var(--light)"/>
<rect x="34.8" y="33" width="2.2" height="6.4" fill="var(--light)"/>
</svg>
<figcaption style="font-size:0.78rem;margin-top:0.4rem"><code>la table à langer</code></figcaption>
</figure>

<figure style="margin:0;text-align:center">
<svg viewBox="0 0 48 48" width="58" height="58" role="img" aria-label="pictogramme cafétéria">
<rect width="48" height="48" rx="7" fill="var(--dark)"/>
<rect x="14.4" y="9" width="1.9" height="8.4" rx="0.9" fill="var(--light)"/>
<rect x="17.6" y="9" width="1.9" height="8.4" rx="0.9" fill="var(--light)"/>
<rect x="20.8" y="9" width="1.9" height="8.4" rx="0.9" fill="var(--light)"/>
<path d="M14.4 16.6 h8.3 v2.8 q0 2.6 -2.7 3.4 v16.6 h-2.9 v-16.6 q-2.7 -0.8 -2.7 -3.4 z" fill="var(--light)"/>
<path d="M30.6 9 q5.4 3.4 5.4 10.4 q0 4.2 -3 5.2 v14.8 h-2.9 v-14.8 q-3 -1 -3 -5.2 q0 -7 3.5 -10.4 z" fill="var(--light)"/>
</svg>
<figcaption style="font-size:0.78rem;margin-top:0.4rem"><code>la cafétéria</code></figcaption>
</figure>

<figure style="margin:0;text-align:center">
<svg viewBox="0 0 48 48" width="58" height="58" role="img" aria-label="pictogramme infirmerie">
<rect width="48" height="48" rx="7" fill="var(--dark)"/>
<path d="M19.5 9.5 h9 v10 h10 v9 h-10 v10 h-9 v-10 h-10 v-9 h10 z" fill="var(--light)"/>
</svg>
<figcaption style="font-size:0.78rem;margin-top:0.4rem"><code>l'infirmerie</code></figcaption>
</figure>

<figure style="margin:0;text-align:center">
<svg viewBox="0 0 48 48" width="58" height="58" role="img" aria-label="pictogramme information">
<rect width="48" height="48" rx="7" fill="var(--dark)"/>
<circle cx="24" cy="24" r="15" fill="none" stroke="var(--light)" stroke-width="3"/>
<circle cx="24" cy="16.4" r="2.3" fill="var(--light)"/>
<rect x="21.9" y="20.6" width="4.2" height="12.4" rx="1.5" fill="var(--light)"/>
</svg>
<figcaption style="font-size:0.78rem;margin-top:0.4rem"><code>l'information</code></figcaption>
</figure>

<figure style="margin:0;text-align:center">
<svg viewBox="0 0 48 48" width="58" height="58" role="img" aria-label="pictogramme fauteuil roulant">
<rect width="48" height="48" rx="7" fill="var(--dark)"/>
<circle cx="18" cy="11" r="3.4" fill="var(--light)"/>
<path d="M18 15.6 v7.6 h7.6" fill="none" stroke="var(--light)" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
<circle cx="22.5" cy="29.5" r="10.4" fill="none" stroke="var(--light)" stroke-width="2.6"/>
<path d="M25.8 23.2 l4.4 8.4 h4.6" fill="none" stroke="var(--light)" stroke-width="2.6" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
<figcaption style="font-size:0.78rem;margin-top:0.4rem"><code>l'accès pour personnes en fauteuil roulant</code></figcaption>
</figure>
